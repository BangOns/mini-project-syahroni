...
export default function ModalTableKehadiranDetailMahasiswa({ DataMahasiswa }) {
  ...
  return (
    <article
      ...
      } w-screen h-screen absolute bg-black/30 top-0 left-0  justify-center items-center`}
    >
      <article className=" w-full min-h-full md:w-3/4 md:min-h-[355px] bg-white rounded">
